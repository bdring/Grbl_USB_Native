// ======================================================================
// Grbl_USB_Native.v generated from TopDesign.cysch
// 07/15/2018 at 12:58
...
module top ;
    ...
    defparam Status_Limit.NumInputs = 6;
	...
	wire [0:0] tmpOE__Pin_A_Lim_net;
	wire [0:0] tmpIO_0__Pin_A_Lim_net;
	wire [0:0] tmpINTERRUPT_0__Pin_A_Lim_net;
	electrical [0:0] tmpSIOVREF__Pin_A_Lim_net;

	cy_psoc3_pins_v1_10
		#(.id("f5905b16-cdd6-4b73-bdea-9a3cb9b3a216"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_A_Lim
		 (.oe(tmpOE__Pin_A_Lim_net),
		  .y({1'b0}),
		  .fb({Net_101}),
		  .io({tmpIO_0__Pin_A_Lim_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_A_Lim_net),
		  .interrupt({tmpINTERRUPT_0__Pin_A_Lim_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_A_Lim_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Debouncer_v1_0 Debouncer_A (
        .d(Net_101),
        .clock(Net_377),
        .q(Net_522),
        .neg(Net_102),
        .either(Net_103),
        .pos(Net_104));
    defparam Debouncer_A.EitherEdgeDetect = 0;
    defparam Debouncer_A.NegEdgeDetect = 1;
    defparam Debouncer_A.PosEdgeDetect = 0;
    defparam Debouncer_A.SignalWidth = 1;


    assign Net_521 = ~Net_522;
    ...
    defparam Control_Reg_Step.Bit3Mode = 3;
    defparam Control_Reg_Step.Bit4Mode = 3;
    defparam Control_Reg_Step.Bit5Mode = 3;
    ...
    defparam Control_Reg_Step.NumOutputs = 6;
    ...
    defparam Control_Reg_Dir.NumOutputs = 6;
	...
	wire [0:0] tmpOE__Pin_Dir_A_net;
	wire [0:0] tmpFB_0__Pin_Dir_A_net;
	wire [0:0] tmpIO_0__Pin_Dir_A_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Dir_A_net;
	electrical [0:0] tmpSIOVREF__Pin_Dir_A_net;

	cy_psoc3_pins_v1_10
		#(.id("7cdfdf36-4e5b-409a-8255-d5365ccbb9c4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Dir_A
		 (.oe(tmpOE__Pin_Dir_A_net),
		  .y({Net_511}),
		  .fb({tmpFB_0__Pin_Dir_A_net[0:0]}),
		  .io({tmpIO_0__Pin_Dir_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Dir_A_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Dir_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Dir_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Step_A_net;
	wire [0:0] tmpFB_0__Pin_Step_A_net;
	wire [0:0] tmpIO_0__Pin_Step_A_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Step_A_net;
	electrical [0:0] tmpSIOVREF__Pin_Step_A_net;

	cy_psoc3_pins_v1_10
		#(.id("4f0b6035-e56d-4549-83a2-35ce37046259"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Step_A
		 (.oe(tmpOE__Pin_Step_A_net),
		  .y({Net_512}),
		  .fb({tmpFB_0__Pin_Step_A_net[0:0]}),
		  .io({tmpIO_0__Pin_Step_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Step_A_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Step_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Step_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_708 = ~Net_666;

    ZeroTerminal ZeroTerminal_1 (
        .z(Net_12));

    Timer_v2_70_1 Stepper_Timer (
        .reset(Net_12),
        .interrupt(Net_244),
        .enable(1'b1),
        .trigger(1'b1),
